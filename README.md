...
- [Installation](#installation)
  - [Clone the Repository](#first-clone-the-repo)
  - [Navigate to the Directory](#then-go-to-the-project-folder)
  - [Install the Package](#finally-you-can-install-it-locally-with-the-following-command)
- [Usage](#usage)
- [Example](#example)
- [Support](#support)
- [Credits](#credits)
